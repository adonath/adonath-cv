...
%------------------------------------------------
\cvitem{\textbf{MPIK} \\ \textcolor{gray}{2018--present}}{Postdoctoral researcher, non-thermal astrophysics, Max-Planck-Institut for Nuclear Physics (MPIK), Heidelberg. Supervised by Jim Hinton}
...
\cvitem{\textbf{Gamma} \\ \textcolor{gray}{June 2016}}{The H.E.S.S. Galactic Plane Survey, 6th International Symposium on High-Energy Gamma-Ray Astronomy, Heidelberg}
\cvitem{\textbf{TeVPa} \\ \textcolor{gray}{June 2016}}{The H.E.S.S. Galactic Plane Survey, TeV Particle Astrophysics, Geneva}
...
\subsection{Software}
\raggedright ** Invited talks / tutorials
\cvitem{\textbf{DAG} \\ \textcolor{gray}{Autumn 2014}}{Astropy - A community developed core package for Astronomy in Python, German Astronomical Society (DAG), Bamberg}
\cvitem{\textbf{PyGamma15} \\ \textcolor{gray}{Nov. 2015}}{An overview of Astropy, Sherpa and Gammapy, Python in Gamma Ray Astronomy Conference, Heidelberg}
\cvitem{\textbf{PyGamma19} \\ \textcolor{gray}{March 2019}}{Gammapy - A Python Package for Gamma-Ray Astronomy, Python in Gamma Ray Astronomy Conference, Heidelberg}
...
\cvitem{\textbf{**Sexten} \\ \textcolor{gray}{June 2021}}{\textit{Gammapy} tutorial, Multimessenger Data Analysis in the CTA era Summer School, Dortmund}
\cvitem{\textbf{**HAWC} \\ \textcolor{gray}{June 2020}}{\textit{Gammapy} tutorial, Multimessenger Data Analysis in the CTA era Summer School, Remote}
...
\cvitem{\textbf{**Asterics-Obelics} \\ \textcolor{gray}{2017, 2018 and 2019}}{\textit{Astropy} tutorial, 1st ASTERICS-OBELICS International School, Annecy}
