...
\homepage{www.axeldonath.com}                         % optional, remove / comment the line if not wanted
...
\social[googlescholar]{vH26Bj0AAAAJ}                % optional, remove / comment the line if not wanted
...
\cvitem{\textbf{MPIK} \\ \textcolor{gray}{2014--2018}}{Doctoral student, high energy astrophysics, Max-Planck-Institut for Nuclear Physics (MPIK), Heidelberg. Supervised by Werner Hofmann}
\cvitem{\textbf{HCI} \\ \textcolor{gray}{2012--2014}}{Student researcher, computer vision, Heidelberg Collaboratory for Image Processing (HCI), Heidelberg. Supervised by Bernd Jähne.}
\cvitem{\textbf{Halle02} \\ \textcolor{gray}{2006--2007}}{Volunteer, Voluntary year in culture at \textit{Atelier Kontrast}, Heidelberg}
%------------------------------------------------
...
\cvitem{\textbf{JOSS} \\ \textcolor{gray}{2022-present}}{I am editor for the astronomy and astrophysics track of the Journal of Open Source Software}
\cvitem{\textbf{Chandra Cycle 24} \\ \textcolor{gray}{2022}}{Faciliation of Chandra guest investigator proposals}
...
\cvitem{\textbf{Scipy 2022} \\ \textcolor{gray}{July 2022}}{Pylira: deconvolution of images in the presence of Poisson noise}
